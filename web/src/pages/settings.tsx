    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm">
          ...
          {isLoading ? (
            <p className="mt-4 text-sm text-gray-600">Loading plan information...</p>
          ) : usage ? (
            <div className="mt-4 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                <h3 className="mb-2 text-sm font-medium text-gray-900">Usage Statistics</h3>
            ...
            <p className="mt-4 text-sm text-red-600">Failed to load plan information</p>
          )}
        </div>
